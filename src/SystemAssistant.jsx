  ...
  if (!isOpen) {
    return (
      <button 
        ...
        className="fixed bottom-10 left-10 z-[99999] bg-slate-900 hover:bg-black text-amber-400 p-2 rounded-full shadow-2xl transition flex items-center space-x-2 cursor-pointer border border-slate-700"
